                    ...
                    <div class="row">
                                ...
                                <div class="blog-item-content bg-white p-5">
                                    <div class="blog-item-meta bg-gray py-1 px-2">
                                        ...
                                        <span class="text-black text-capitalize mr-3"><i class="ti-time mr-1"></i>
                                            <?php the_time('jS F'); ?></span>
                                    </div>

                                    <h2 class="mt-3 mb-4"><a href="blog-single.html">
                                            <?php the_title(); ?>
                                        </a></h2>
                                    <?php the_content(); ?>
                                    ...
                                    <div class="tag-option mt-5 clearfix">
                                        <ul class="float-left list-inline">
                                            ...
                                            <li class="list-inline-item"><?php the_tags(); ?>
                                            </li>
                                        </ul>

                                        <ul class="float-right list-inline">
                                            <li class="list-inline-item"> <?php esc_html_e('Share:', 'megakit') ?>
                                            </li>
                                            <?php
                                            $single_post_socials = get_field('single_post_social', 'option');

                                            foreach ($single_post_socials as $single_post_social) { ?>
                                            <li class="list-inline-item"><a
                                                    href="<?php echo $single_post_social['social_url'] ?>"
                                                    target="_blank"><i class="<?php echo $single_post_social['icon'] ?>"
                            ...
                            <div class="posts-nav bg-white p-5 d-lg-flex d-md-flex justify-content-between ">
                                <a class="post-prev align-items-center" href="#">
                                    <div class="posts-prev-item mb-4 mb-lg-0">
                                        <span
                                            class="nav-posts-desc text-color"><?php esc_html_e('- Previous Post', 'megakit') ?></span>
                                ...
                                <a class="posts-next" href="#">
                                    <div class="posts-next-item pt-4 pt-lg-0">
                                        <span class="nav-posts-desc text-lg-right text-md-right text-color d-block"><?php esc_html_e('-
                                            Next Post', 'megakit') ?></span>
                                        <h6 class="nav-posts-title mt-1">
                                            <?php next_post_link(); ?>
                                        </h6>
                                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="contact-form bg-white rounded p-5" id="comment-form">
                                <?php echo  do_shortcode('[contact-form-7 id="182" title="Write a comment"]') ?>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="sidebar-wrap">
                        ...
                        <div class="sidebar-widget latest-post card border-0 p-4 mb-3">
                            ...
                            <?php if (is_active_sidebar('main_sidebar_post')) { ?>
                            <?php dynamic_sidebar('main_sidebar_post'); ?>
                            <?php } ?>
                        </div>
                        ...
                        <div class="sidebar-widget bg-white rounded tags p-4 mb-3">
                            ...
                            <?php if (is_active_sidebar('main_sidebar_tags')) { ?>
                            <?php dynamic_sidebar('main_sidebar_tags'); ?>
                            <?php } ?>
                        </div>
                    </div>
                </div>
